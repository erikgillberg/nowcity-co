...
const METRICS: Metric[] = [
  ...
  },
  {
    ...
    delta: '6 to 18 mo faster',
    method:
      'Comparison against internal case files plus ULI PNW entitlement benchmarks for comparable-scale mixed-use infill.',
  },
  {
    id: 'cost-of-capital',
    ...
    traditional: {
      value: '8.0-9.5%',
      note: 'Conventional merchant-build stack, senior debt plus market-rate equity only.',
    },
    delta: '150 to 250 bps lower',
    method:
  ...
  {
    id: 'carbon',
    label: 'Carbon (embodied plus operational)',
  ...
  },
  {
    ...
    delta: '2-3x uplift',
    method:
      'Projected on NCN benchmark of 105,000 SF experiential retail plus flex plus small-biz space. Informed by Shuman local-multiplier research.',
  },
  {
    id: 'resilience',
    ...
    ncn: {
      value: 'Tier 1',
      note: 'District energy plus storage, on-site water, passive thermal performance.',
    },
    traditional: {
      value: 'Tier 3',
